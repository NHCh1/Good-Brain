...
public class BlankPlotChart extends JComponent{
    ...
    public void setBlankPlotChartRender(BlankPlotChartRender blankPlotChatRender) {
        this.blankPlotChartRender = blankPlotChatRender;
    }
    ...
    public void initValues(double minVal, double maxVal) {
        this.minValues = minVal;
